      ...
      <section>
        <div className="container mx-auto max-w-5xl ">
          <div className="flex py-20 flex-col">
            <p className="text-2xl  text-[#101110] mb-5 ">
             <b> Privacy Policy of Carbon Shredder Last Updated: 17 January 2024</b>
            </p>

            <p className="text-lg  text-[#101110] mb-10">
            ...
            <h2 className="text-2xl mb-3 capitalize">1. Important Information and who we are</h2>
            <p className="text-lg  text-[#101110] mb-5 px-5">
            ...
            <h2 className="text-2xl mb-3 capitalize">2. Data collection</h2>
            <p className="text-lg  text-[#101110]  px-5 pb-2 ">
            ...
            <h2 className="text-2xl mb-3 capitalize">3. Data usage</h2>
            <p className="text-lg  text-[#101110] mb-5 px-5">
            ...
            <h2 className="text-2xl mb-3 capitalize">4. Data sharing</h2>
            <p className="text-lg  text-[#101110] mb-5 px-5">
            ...
            <h2 className="text-2xl mb-3 capitalize">5. User consent and control</h2>
            <p className="text-lg  text-[#101110] px-5 pb-2">
            ...
            <h2 className="text-2xl mb-3 capitalize">6. Data security</h2>
            <p className="text-lg  text-[#101110] mb-5 px-5">
