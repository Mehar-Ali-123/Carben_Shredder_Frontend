...
c-0.328-5.555-2.622-10.738-6.59-14.706L34.5,6.086c14.154,0.922,25.438,9.585,26.429,20.368L60.589,26.308z"
            ...
            <div className="w-full  flex justify-center items-center">
              ...
              >
                <button className="rounded-md bg-text-primary px-3 py-2 text-sm font-semibold leading-6 bg-primary text-white shadow-md w-full text-center">
                  Ready To Buy
                </button>
              </Link>
            </div>
          ...
          <div class="relative overflow-x-auto mx-44 mb-20 mt-10">
              ...
              <tbody>
                {filteredTransactions.map((transaction) => (
                  <tr key={transaction.id}>
                    ...
                    <td class="px-6 py-4 text-center">
                      {(calculateCO2(transaction, plaidData) || 0).toFixed(6)}
                    </td>
                    <td class="px-6 py-4  text-center">
                      {(calculateCO2(transaction, plaidData) * 20 || 0).toFixed(
                        6
                      )}{" "}
                      $
                    </td>
