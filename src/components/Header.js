          ...
          <header className="navbar change-color px-0 flex justify-between items-center ">
            <div className="container-fluid mx-0 flex flex-wrap p-3 flex-col md:flex-row items-center justify-between   w-[100%] py-0  ">
              <div className="  hidden lg:flex   container-fluid mx-0  flex-wrap p-3 flex-col md:flex-row items-center justify-between   w-[100%] py-1 ">
                ...
                >
                  <img src={Logo} className="w-[55px] h-[75px]  object-cover" alt="Logo" />
                ...
                <nav className="hidden lg:flex mx-auto   flex-col lg:flex-row   mt-3 lg:mt-0 lg:w-[59%] lg:items-center lg:justify-center ">
                  <Link
                    to="/"
                    className="mr-5  tracking-[2px] text-[14px] text-center hover:text-primary   hover:underline font-hel-bold  mx-0 px-0 font-hel-bold"
                  >
                  ...
                  <Menu className="relative" as="div">
                    <Link to="">
                      <Menu.Button className="mr-5  text-[#101110]    text-center hover:text-primary   hover:underline font-hel-bold flex flex-row items-center gap-1">
                    ...
                    <Link
                      to=""
                      className=" tracking-[2px] text-[11px]  text-[#101110]  mx-5 my-2 hover:text-primary   hover:underline font-hel-bold"
                    >
                      How It works ?
                    </Link>
                  </Menu.Item> */}
                      <Menu.Item>
                        <Link
                          ...
                          className="tracking-[2px] text-[12px]  text-[#101110] mx-5 my-2 hover:text-primary   hover:underline font-hel-bold"
                        >
                      ...
                      <Menu.Item>
                        <Link
                          ...
                          className="  text-[#101110]  tracking-[2px] text-[12px] mx-5 my-2 hover:text-primary   hover:underline font-hel-bold"
                        >
                  ...
                  <Link
                    ...
                    className="mr-5   tracking-[2px] text-[14px]  text-center hover:text-primary   hover:underline font-hel-bold font-hel-bold"
                  >
                    Our Mission
                  </Link>
                  <Link
                  ...
                  >
                    <span className="hover:text-primary   hover:underline font-hel-bold  tracking-[2px] text-[14px]">
                      Connect
                    </span>
                  </Link>
                  {isAuthenticated == "true" ? (
                    <Menu className="relative" as="div">
                      <Link>
                        <Menu.Button className="mr-5  text-[#101110] text-2xl md:text-[18px]   text-center hover:text-primary   hover:underline font-hel-bold flex flex-row items-center gap-1">
                          <span className="hover:text-primary   hover:underline font-hel-bold  tracking-[2px] text-[14px]">
                            Profile
                          </span>
                          <svg
                    ...
                    >
                      <span className=" hover:text-primary   hover:underline font-hel-bold ">
                        Sign In
                      </span>
                    </Link>
                  )}
              ...
              <div className="   flex justify-between items-center w-[100%] lg:hidden">
                <div className="flex md:hidden  w-auto md:w-[20%]  justify-center">
                  ...
                  >
                    <img src={Logo} className="w-[45px] h-[65px]" alt="Logo" />
                ...
                <div className="hidden md:flex  w-auto md:w-[20%]  justify-center">
                  ...
                  >
                    <img src={Logo} className="w-[55px] h-[75px] " alt="Logo" />
                    <span className="text-xs font-semibold">
                      Carbon Shredder
                    </span>
                  </Link>
                ...
                >
                  ...
                  <ul className="flex flex-col gap-5 md:gap-10 items-start p-10 w-[100%] mt-10">
                    ...
                    >
                      <Link
                        to="/"
                        className=" text-[#101110]  font-extrabold text-start hover:text-primary   hover:underline font-hel-bold  tracking-[2px] text-[14px]"
                      >
                        Home
                      </Link>
                    </li>
                    <li className="hover:bg-[#FBF4DB] p-2">
                      <Menu className="relative" as="div">
                        <Link to="">
                          <Menu.Button className=" text-[#101110]  tracking-[2px] text-[14px] font-extrabold text-start hover:text-primary   hover:underline font-hel-bold mr-5    flex flex-row items-center gap-2 ">
                            How it works
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              fill="none"
                    ...
                    >
                      {/* <Menu.Item>
                        <Link
                          onClick={() => setIsOpen(false)}
                          to=""
                          className="  text-[#101110]   tracking-[2px] text-[14px] mx-5 my-2 hover:text-primary   hover:underline font-hel-bold"
                        >
                          How it works ?
                        </Link>
                      </Menu.Item> */}
                    ...
                    >
                      <Link
                        to="/about-our-mission"
                        className=" text-[#101110]  tracking-[2px] text-[14px] font-extrabold text-start hover:text-primary   hover:underline font-hel-bold  "
                      >
                        Our Mission
                      </Link>
                    </li>
                    ...
                    >
                      <Link
                        to="/contact"
                        className=" text-[#101110]  tracking-[2px] text-[14px] font-extrabold text-start hover:text-primary   hover:underline font-hel-bold w-full "
                      >
                        Contact
                      </Link>
                    </li>
                    <li className="hover:bg-[#FBF4DB] p-2">
                      {isAuthenticated == "true" ? (
                        <Menu className="relative" as="div">
                          ...
                          >
                            <Menu.Button className="mr-5  text-[#101110]    text-center hover:text-primary   hover:underline font-hel-bold flex flex-row items-center gap-1">
                              <span className="hover:text-primary font-extrabold   hover:underline font-hel-bold  tracking-[2px] text-[14px]">
                                Profile
                              </span>
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                          ...
                          >
                            <Menu.Item>
                              <Link
                                onClick={() => setIsOpen(false)}
                                to="/personal-profile"
                                className="  text-[#101110]  tracking-[2px] text-[11px] mx-5 my-2 hover:text-primary   hover:underline font-hel-bold "
                              >
                                View Profile
                              </Link>
                            </Menu.Item>
                        ...
                        <Link
                          onClick={() => setIsOpen(false)}
                          to="/sign-in"
                          className=" text-[#101110]  tracking-[2px] text-[14px] font-extrabold hover:text-primary   hover:underline font-hel-bold "
                        >
                          Sign In
                        </Link>
                      )}
